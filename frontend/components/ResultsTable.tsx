  ...
  return (
    <div className="rounded-3xl border border-slate-700 bg-slate-950 p-6 shadow-card">
      <div className="mb-4 flex items-center justify-between gap-3">
        ...
        <div className="rounded-full bg-slate-800 px-3 py-1 text-sm font-semibold text-slate-100">
      ...
      <div className="mt-4 flex justify-end">
        <button
          ...
          className="btn-primary bg-[#003d9b] text-white transition hover:bg-[#002e7d] disabled:cursor-not-allowed disabled:opacity-50"
